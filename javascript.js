...
chart.load([
    ...
    { id: 3, orderBy: 3, pids: [4], fid: 1, mid: 2, name: "BÙI ĐẠT BỒI",  title: "(1900-1900)", gender: "male" },
    { id: 4, orderBy: 4, pids: [3],            name: "BÙI THỊ BỒI",      title: "",          gender: "female" },
    ...
    { id: 9, orderBy: 9, pids: [8],            name: "BÙI THỊ LIÊN",  title: "",      gender: "female" },

    // ===== ĐỜI CHÁU =====
    // Con của BÙI ĐẠT BỒI – BÙI THỊ BỒI
    // Ô QUYỀN: BÙI ĐẠT QUYỀN – BÙI THỊ QUYỀN
    { id: 10, orderBy: 10, pids: [19], fid: 3, mid: 4, name: "BÙI ĐẠT QUYỀN", title: "", gender: "male" },
    { id: 19, orderBy: 19, pids: [10],            name: "BÙI THỊ QUYỀN",      title: "", gender: "female" },
    ...
    { id: 17, orderBy: 17, fid: 8, mid: 9, name: "BÙI ĐẠT TIẾN", title: "(1884-1900)", gender: "male" },
    ...
    { id: 22, orderBy: 22, pids: [36], fid: 10, mid: 19, name: "BÙI ĐẠT HINH", title: "", gender: "male" },
    { id: 36, orderBy: 36, pids: [22],                 name: "BÙI THỊ CHÍN",   title: "", gender: "female" },

    { id: 23, orderBy: 23, fid: 10, mid: 19, name: "BÙI THỊ EM",   title: "", gender: "female" },

    // Con của BÙI ĐẠT SẤC – TRẦN THỊ XUÂN
    // NHÂN, NGHĨA, LỢI, MINH LỘC
    { id: 24, orderBy: 24, fid: 14, mid: 20, pids: [37], name: "BÙI THỊ NHÂN",      title: "", gender: "female" },
    { id: 37, orderBy: 37, pids: [24],                  name: "NGUYỄN ĐÌNH NGÂN",   title: "", gender: "male" },

    { id: 25, orderBy: 25, fid: 14, mid: 20, pids: [38], name: "BÙI ĐẠT NGHĨA",     title: "", gender: "male" },
    { id: 38, orderBy: 38, pids: [25],                  name: "NGUYỄN THỊ SÁU",     title: "", gender: "female" },

    { id: 26, orderBy: 26, fid: 14, mid: 20, pids: [39], name: "BÙI THỊ LỢI",       title: "", gender: "female" },
    { id: 39, orderBy: 39, pids: [26],                  name: "BÙI XUÂN KỲ",        title: "", gender: "male" },

    { id: 27, orderBy: 27, fid: 14, mid: 20, pids: [40], name: "BÙI THỊ MINH LỘC",  title: "", gender: "female" },
    { id: 40, orderBy: 40, pids: [27],                  name: "ĐINH ĐĂNG TRINH",    title: "", gender: "male" },
    ...
    { id: 41, orderBy: 41, pids: [28],                 name: "ĐÀO THỊ NHUẦN",   title: "",           gender: "female" },
    ...
    { id: 97, orderBy: 97, pids: [77],                  name: "HỒ VĂN ĐÔNG",         title: "",      gender: "male" },
    { id: 78, orderBy: 78, fid: 50, mid: 58, name: "BÙI ĐẠT XYZ",          title: "",      gender: "male" },
    ...
    { id: 98, orderBy: 98, pids: [83],                  name: "NGUYỄN THỊ QUẾ", title: "",       gender: "female" },
